...
public class JDBCConnection {
	...
	//private String login = "kpierz2s";
	//private String password = "kpierz2s";
	private String url = "jdbc:postgresql://dumbo.inf.h-brs.de:5432/kpierz2s";
	...
	public void openConnection() throws DatabaseException {
		...
		props.setProperty("user", "kpierz2s");
		props.setProperty("password" ,"kpierz2s" );
